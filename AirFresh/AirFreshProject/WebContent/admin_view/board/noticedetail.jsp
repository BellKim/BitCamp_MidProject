...
<body>
	<div class="container">
		...
		<div class="card bg-secondary mb-3">
			<div class="card-header"><h3 class="card-title"><%=notice.getNoti_title()%></h3><span><%=sdate %></span></div>
			<div class="card-body">
				...
				if(str.equals("png")||str.equals("PNG")||str.equals("JPG")||str.equals("jpg")||str.equals("gif")||str.equals("GIF")){
				
				%>
					<p class="card-text">
					<img src="http://localhost:8090/AirFreshProject/upload/<%=notice.getTempfile() %>.<%=str %>">
					</p>
				<% } %>
		...
		<div align ="center">
			<button type="button" class="btn btn-primary btn-lg" onclick="location.href='<%=request.getContextPath()%>/noticelist'">목록</button>
		</div>
	</div>
</body>
</html>