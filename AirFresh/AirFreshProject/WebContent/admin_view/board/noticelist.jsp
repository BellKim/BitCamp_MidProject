...
<table class="table table-hover">
	...
	%>
	    ...
	    %>
	    	<tr align="center">
	    		<th><%=i+1 %></th>
	    		<td align="left"><a href="noticedetail.jsp?seq="<%=notice.getNoti_index()%>"><%=notice.getNoti_title() %></a></td>
...
<div align = "right">
<button type="button" class="btn btn-primary" onclick="location.href='./admin_view/board/notice_write.jsp'">글쓰기</button>
</div>
</div>
</body>
</html>